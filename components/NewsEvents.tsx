...
const NewsAndEventsPage = () => {
  ...
  <div className="absolute inset-0">
    ...
    {/* Dynamic yellow accents */}
    <div className="absolute -top-20 -left-20 w-96 h-96 bg-yellow-400 rounded-full opacity-10 blur-3xl"></div>
    <div className="absolute bottom-0 right-0 w-80 h-80 bg-yellow-300 rounded-full opacity-10 blur-3xl transform translate-x-1/4 translate-y-1/4"></div>
