  ...
  export const experienceCamputLife= [
   ...
   export const states = [
    ...
    export  const cities = {
      ...
      "Himachal Pradesh": ["Shimla", "Mandi", "Solan", "Dharamshala", "Kullu", "Chamba", "Hamirpur", "Una", "Nahan"],
      ...
      "Tripura": ["Agartala", "Dharmanagar", "Belonia", "Kailasahar", "Ambassa", "Khowai", "Teliamura", "Bishramganj", "Amarpur"],
